# Perception Layer (`visionPerception`)
...
This means:
 ...
 - The physical board detected by `vision::core` is invariant under $D_4$ symmetry transformations. Once a stone (or two stones if the first is in center) is placed, the symmetry is broken and we can map to our expected board coordinates.
...
The planned image detection loop has few events:
 - New stone detected
 - Board lost
